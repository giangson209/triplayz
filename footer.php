<footer class="relative bg-blue px-6 md:px-10 py-6 md:py-10">
    <div class="wrapper">
                            ...
                            <div class="item md:border-r border-[#FFFFFF26] pr-0 md:pr-10 3xl:pr-0 relative pl-6 md:pl-0">
                                ...
                                <div class="item mb-8 3xl:mb-25 last:mb-0">
                                    ...
                                    <ul>
                                        ...
                                        <li class="mb-3 md:mb-6 last:mb-0"><a href="">BFSI Solution</a></li>
                                ...
                                <div class="item mb-8 3xl:mb-25 last:mb-0">
                                    ...
                                    <ul>
                                        ...
                                        <li class="mb-3 md:mb-6 last:mb-0"><a href="">Career</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="item md:border-r border-[#FFFFFF26] pr-0 md:pr-10 3xl:pr-0 relative pl-6 md:pl-0">
                                ...
                                <div class="item mb-8 3xl:mb-25 last:mb-0">
                                    ...
                                    <ul>
                                        ...
                                        <li class="mb-3 md:mb-6 lg:mb-18 last:mb-0">
                                            T: (+84) 868 217 954 <br>
                                            (日本): 050 5539 3197 <br>
                                            E: contact@triplayz.com
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="block md:hidden pl-6 mb-6 relative">
                                <div class="absolute top-0 left-0 w-[1px] h-full bg-[#FFFFFF26]"></div>
