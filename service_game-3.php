    ...
    <section class="relative pt-10 md:pt-25 3xl:pt-58 pb-10 md:pb-20 px-4 md:px-10 overflow-hidden">
        ...
        <div class="wrapper relative z-2">
            <div
                ...
                End-to-end development across the full financial services spectrum — for fintech enterprises, digital
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10">
                <div class="item block lg:flex flex-col justify-between gap-10">
                    <div class="w-full max-w-full lg:max-w-131 anek opacity-85">
                        We help brands create immersive digital experiences that turn passive audiences into active
                ...
                <div class="item text-white lg:text-[#56565D]">
                    <div
                        class="item-game group flex items-center relative w-full border-b-[1px] border-[#FFFFFF26] pb-6 mb-6 last:mb-0">
                        <div
        ...
        <div class="wrapper relative z-2 flex items-center justify-center h-full px-4 md:px-10">
            <div class="w-full max-w-217 m-auto">
                ...
                <div class="anek opacity-85 m-auto w-full max-w-121">
                    Enterprise BFSI platforms engineered with compliance, security, and scale from day one — not patched
                    in after launch.
                </div>
            </div>
        </div>
            ...
            for ($x = 1; $x <= 6; $x++) { ?>
                <div
                    ...
                    <div class="top flex items-center justify-between">
                        ...
                        <div class="doto text-6 md:text-[48px] 2xl:text-[64px] font-bold opacity-25">/0
                            <?php echo $x; ?>
                        </div>
                    </div>
                    <div class="anek opacity-85 pt-5 md:pt-6 mt-3 md:mt-6 border-t-[1px] border-[#FFFFFF26] text-left">
                        Built to match your brand, industry, and campaign goal. Your game, your rules — designed to deliver
                        measurable results
                    </div>
                </div>
            <?php }
