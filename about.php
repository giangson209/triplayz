...
<script>
    const items = [
        { date: "09.2023", title: "Founded & Strategically Positioned", desc: "Triplayz was founded by a team with deep expertise in Gamification and Fintech. From day one, we positioned ourselves as a new-generation tech partner." },
        { date: "12.2023", title: "Expanding Core Team", desc: "We gathered top talents from across the industry to build a foundation of excellence in digital solutions and BFSI excellence." },
        { date: "03.2024", title: "Entering the Japan Market", desc: "Successfully established partnerships with key Japanese enterprises, delivering tailored gamification solutions for their ecosystems." },
        { date: "06.2024", title: "Innovative Product Launch", desc: "Launched our first major gamified engagement platform, helping clients increase user retention by over 40%." },
        { date: "09.2024", title: "Global Strategic Growth", desc: "Expanded our reach to multiple regions, becoming a trusted global tech partner that turns vision into measurable reality." }
    ];
