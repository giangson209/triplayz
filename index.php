...
<main>
    <section class="relative overflow-hidden">
        ...
        <div class="wrapper p-6 md:p-10 min-h-[unset] md:min-h-[100vh] relative">
            <div class="relative md:absolute top-[-13%] lg:top-0 left-[16%] md:left-[10%] lg:left-0 flex items-center z-2 w-full justify-center xl:justify-start scale-[1.8] md:scale-[1]">
            ...
            <div class="relative md:absolute z-3 bottom-0 right-0 px-0 md:px-10 max-w-full xl:max-w-[60%] text-center md:text-left">
                <div class="mb-12 3xl:mb-20">
                    <div class="text-10 md:text-[48px] lg:text-[64px] 2xl:text-[80px] 3xl:text-[100px] font-medium mb-8 3xl:mb-10">a global end-to-end
                        tech partner</div>
                    <div class="btn-main">
                        <a href="">
                            TALK WITH US
                ...
                <div class="py-6 2xl:py-8 3xl:py-10 border-t border-[#FFFFFF26] block md:flex items-center justify-between gap-6 md:gap-16 2xl:gap-8 3xl:gap-10 text-center md:text-left">
                    <div class="item anek max-w-121 w-full text-center md:text-left mb-6 md:mb-0">
                        Gamification, BFSI solutions, and digital solutions under one roof, helping enterprises across industries engage customers and grow sustainably
                    </div>
    ...
    <section class="relative h-[unset] lg:h-[100vh] flex items-center justify-center text-center py-20 lg:py-0 wrapper">
        <div class="absolute top-0 left-0 w-full h-full flex items-center justify-center">
            <img src="assets/images/union.png" class="inline" alt="">
        </div>
        <div class="block lg:flex items-center justify-center text-10 2xl:text-[64px] 3xl:text-[72px] font-medium gap-10 xl:gap-30 2xl:gap-8 relative z-2">
            <div class="txt">where vision</div>
            <div class="text-center py-10 lg:py-0">
                <div class="icon -mb-8 last:mb-0">
        ...
        <div class="wrapper relative">
            ...
            <div class="block lg:flex mb-6 md:mb-20 gap-50 relative z-2">
                ...
                <div class="wraper max-w-300">
                    <h2 class="text-8 md:text-[48px] lg:text-[64px] 2xl:text-[80px] 3xl:text-[100px] font-medium leading-[1.25]">What our purpose-built
                        <br class="hidden xl:block">solutions can do for <br  class="hidden xl:block"><span class="text-[#56565D]">your growth strategy</span></h2>

                    <div class="mt-6 md:mt-10 lg:mt-14 3xl:mt-36 flex items-end gap-x-10 xl:gap-x-82 justify-between 3xl:justify-[unset] flex-wrap md:flex-[unset]">
                        ...
                        <div class="max-w-full md:max-w-1/2 xl:max-w-103 w-full anek opacity-85 order-1 md:order-2 mb-6 md:mb-0">
                            We combine technical precision with strategic thinking — so every solution we deliver moves your business meaningfully forward.
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="hidden md:grid grid-cols-12 relative pt-12 gap-10 xl:gap-25 min-h-180 2xl:min-h-200">
                    <div class="item col-span-5 3xl:col-span-4 h-full flex flex-col justify-between gap-10">
                        ...
                        <div class="tags gap-3.5 flex flex-wrap anek text-4 3xl:text-5">
                            <a href="" class="inline-flex rounded-0.5 py-4 px-5 bg-[#FFFFFF14]">Web & App Development</a>
                            <a href="" class="inline-flex rounded-0.5 py-4 px-5 bg-[#FFFFFF14]">UI/UX & Creative Design</a>
                            <a href="" class="inline-flex rounded-0.5 py-4 px-5 bg-[#FFFFFF14]">Bussiness Platform & System Intergration</a>
                            <a href="" class="inline-flex rounded-0.5 py-4 px-5 bg-[#FFFFFF14]">MVP-as-a-Service</a>
                            <a href="" class="inline-flex rounded-0.5 py-4 px-5 bg-[#FFFFFF14]">Data Visualization & Analytics</a>
                        </div>
                    </div>
    ...
    <section class="relative px-6 md:px-10 py-10 overflow-hidden">
        <div class="wrapper relative overflow-hidden">
            <div class="text-[56px] md:text-[100px] lg:text-[124px] 2xl:text-[164px] 3xl:text-[200px] font-medium mb-4">WHY US?</div>
            ...
            <div class="py-20 relativeoverflow-hidden hidden md:block">
                ...
                <div class="relative">
                    <div class="w-[45%] 3xl:w-1/2 ml-[-25%] flex items-center relative z-4">
                        ...
                        <div class="absolute top-0 right-[-100px] 3xl:right-[-160px] flex items-center justity-center h-full">
                    ...
                    <div class="absolute top-0 left-0 w-full h-full flex items-center pl-[36%] 3xl:pl-[40%]">
                        <div class="max-w-full flex items-center justify-center gap-6 lg:gap-10 xl:gap-20 3xl:gap-32">
                            <div class="avarta w-full max-w-36 lg:max-w-60 xl:max-w-85 3xl:max-w-105"><img src="assets/images/why.png" class="max-w-105" alt=""></div>
                            <div class="desc">
                                <div class="font-medium text-[48px] xl:text-[80px] 2xl:text-[112px] 3xl:text-[142px]">50+</div>
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    for ($x=1;$x<=4;$x++) { ?>
                        <div class="item flex items-center">
                            <div class="avarta w-full max-w-36 flex-[0_0_144px]"><img src="assets/images/why.png" class="w-full" alt=""></div>
                            <div class="desc pl-6">
                        ...
                        <div class="swiper-wrapper">
                            <?php for ($x=1;$x<=15;$x++) { ?>
                                <div class="swiper-slide">
                                    <div class="item flex items-center py-4 md:py-7.5 px-8 md:px-20 bg-[#FFFFFF0D] rounded-[2px] overflow-hidden"><img src="assets/images/partner.png" alt=""></div>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
    ...
    <section class="relative py-10 md:py-20 3xl:py-25 px-6 md:px-10 bg-white">
        <div class="wrapper relative">
            ...
            <div class="item col-span-5 md:col-span-2 2xl:col-span-1 h-[auto] md:h-[80vh] block md:sticky top-25 pb-6 md:pb-0 mb-6 md:mb-0 border-b md:border-0 border-[#00000026]">
                <div class="block md:flex flex-col justify-between h-full text-[#1D1D27]">
                    ...
                    <div class="hidden md:block numb text-10 2xl:text-[64px] font-medium">01<span class="opacity-25">/03</span></div>
                    <div class="btn-main">
                ...
                for ($x=1;$x<=8;$x++) { ?>
                    <div class="item item-casestudy mb-6 md:mb-10 3xl:mb-20 last:mb-0">
                        <div class="relative avarta overflow-hidden">
                            ...
                            <div class="hidden md:block absolute desc-absolute top-0 right-0 p-6 w-[55%] bg-[#00000080] border border-[#FFFFFF47]" style="backdrop-filter: blur(74px)">
                        ...
                        <div class="mt-4 md:mt-8">
                            <div class="mb-2 lg:mb-4 flex items-center text-[14px] md:text-4 lg:text-5 font-medium anek gap-3 text-black">
                                <span class="bg-[#7060E5] inline-flex items-center w-3 lg:w-4 h-3 lg:h-4 rounded-[2px]"></span>
                                GAMIFICATIONS
                            </div>
                            <h3>
                                <a href="" class="block text-4 md:text-6 lg:text-8 3xl:text-10 font-medium text-[#1D1D27]">Celebrate SkyJoy’s 2nd Anniversary </a>
                            </h3>
                        </div>
                    </div>
                <?php }
            ...
            <div class="item col-span-12 lg:col-span-6 2xl:col-span-5">
                <div class="bg-white w-full p-10 text-black">
                    ...
                    <div class="grid grid-cols-2 gap-4 3xl:gap-6 anek">
                        <div class="item">
                            <input type="text" class="w-full h-13.5 3xl:h-18 px-5 border border-[#1D1D2726] rounded-1 outline-none" placeholder="Firstname">
                        </div>
                        <div class="item">
                            <input type="text" class="w-full h-13.5 3xl:h-18 px-5 border border-[#1D1D2726] rounded-1 outline-none" placeholder="Lastname">
                        </div>
                        <div class="item">
                            <input type="text" class="w-full h-13.5 3xl:h-18 px-5 border border-[#1D1D2726] rounded-1 outline-none" placeholder="Company">
                        </div>
                        <div class="item">
                            <input type="text" class="w-full h-13.5 3xl:h-18 px-5 border border-[#1D1D2726] rounded-1 outline-none" placeholder="Company email">
                        </div>
                        <div class="item">
                            <input type="text" class="w-full h-13.5 3xl:h-18 px-5 border border-[#1D1D2726] rounded-1 outline-none" placeholder="Phone">
                        </div>
                        <div class="item">
                            <select class="w-full h-13.5 3xl:h-18 px-5 border border-[#1D1D2726] rounded-1 outline-none">
                        ...
                        <div class="item col-span-2">
                            <textarea class="w-full h-28 3xl:h-36 px-5 py-4 border border-[#1D1D2726] rounded-1 outline-none" placeholder="To better assist you, please describe how we can help...."></textarea>
                        </div>
                        <div class="item">
                            <div class="btn-main">
                                <a href="" style="border: 1px solid #1D1D2714; background: #1D1D2714;">
